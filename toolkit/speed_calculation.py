...
TARGET = (4, 38)  # Target position on the minimap
HANDLE = 0x000A13EC  # Handle to the game window
minimap = LudiFreeMarketTemplate()  # Minimap implementation in which the speed is tested (Assumption is that speed may vary from map to map)
