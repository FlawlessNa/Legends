...
class FantasyThemePark1Minimap(MinimapPathingMechanics):
    ...
    rightmost_rocks: MinimapFeature = MinimapFeature(
        left=59, right=65, top=84, bottom=85, name="rightmost_rocks", is_irregular=True
    )
    leftmost_rocks: MinimapFeature = MinimapFeature(
        left=45, right=50, top=83, bottom=84, name="leftmost_rocks", is_irregular=True
    )
    ...
    stair_ramp: MinimapFeature = MinimapFeature(
        left=17, right=22, top=86, bottom=89, name="stair_ramp", is_irregular=True
    )
