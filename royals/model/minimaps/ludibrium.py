...
class LudibriumMinimap(MinimapPathingMechanics):
    ...
    ladder_to_patricia = MinimapFeature(
        left=72, right=72, top=76, bottom=81, name="ladder_to_patricia"
    )

    patricia_platform1 = MinimapFeature(
        left=70, right=83, top=75, bottom=75, name="patricia_platform1"
    )
    patricia_platform2 = MinimapFeature(
        left=70, right=83, top=74, bottom=74, name="patricia_platform2"
    )
