...
from royals.models_implementations.maps import SubwayLine1Area2
...
class SubwayMagicianTraining2(DecisionEngine):
    ...
    def __init__(self, log_queue: multiprocessing.Queue, bot: Executor) -> None:
        ...
        self.game_data.current_map = SubwayLine1Area2()
