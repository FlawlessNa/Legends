...
# Idea - use the GridNote connections for "teleporters" between points and "portals" between maps.
...
class MinimapPathFinder(AStarFinder):
    ...
    - The grid may also contain "portals" towards other grids, used to travel between maps.
